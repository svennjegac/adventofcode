...
func TestOutputItself(t *testing.T) {
	memory, err := day09.Intcode("tests/resources/output_itself.txt")
	if err != nil {
		panic(err)
	}
...
func Test16DigitNumber(t *testing.T) {
	memory, err := day09.Intcode("tests/resources/s16_dig_num.txt")
	if err != nil {
		panic(err)
	}
...
func TestMiddleNum(t *testing.T) {
	memory, err := day09.Intcode("tests/resources/middle_num.txt")
	if err != nil {
		panic(err)
	}
...
func TestMyInputProblem1(t *testing.T) {
	memory, err := day09.Intcode("tests/resources/my_input.txt")
	if err != nil {
		panic(err)
	}
